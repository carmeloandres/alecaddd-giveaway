...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)('alecadd/custom-cta', {
  // bilt-in attributes
  ...
  edit(_ref) {
    ...
    function updateAuthor(event) {
      console.log(event.target.value); // usamos la función setAttribute, propia de los bloques, para asignar el valor a una propiedad
